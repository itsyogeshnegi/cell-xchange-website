...
export default function PhoneForm({ phone, brandsByCategory = {} }) {
  ...
  const visibleFields = phone ? fields : fields.filter(([name]) => !["display", "processor", "camera"].includes(name));
