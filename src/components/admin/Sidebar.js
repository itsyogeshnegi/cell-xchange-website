...
const links=[["/dashboard",LayoutDashboard,"Overview"],["/dashboard/phones",Boxes,"Inventory"],["/dashboard/brands",Tags,"Brands"],["/dashboard/orders",ShoppingBag,"Orders"],["/dashboard/settings",Settings,"Settings"]];
