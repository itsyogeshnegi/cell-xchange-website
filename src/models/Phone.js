...
const phoneSchema = new mongoose.Schema({
  ...
  featured: { type: Boolean, default: false }, latest: { type: Boolean, default: false }, visible: { type: Boolean, default: true, index: true }, images: { type: [imageSchema], validate: { validator(items) { return items.length >= 1 && items.length <= 3; }, message: "Upload 1 to 3 product images" } },
}, { timestamps: true });
