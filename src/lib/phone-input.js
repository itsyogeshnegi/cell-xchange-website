...
export const publicPhoneFields = "category brand model slug description price color storage ram battery processor display camera warrantyStatus condition stock featured latest visible images createdAt updatedAt";
