...
export default async function PhonesPage() {
  ...
  return <section className="container-shell py-16 sm:py-20"><div className="mb-12 max-w-2xl"><p className="eyebrow text-[#718078]">Current collection</p><h1 className="display mt-3 text-5xl font-black sm:text-7xl">Better devices<br/>start here.</h1><p className="mt-5 text-sm leading-6 text-[#69716c]">Compare phones, laptops and smartwatches to find the right fit for your day-to-day.</p></div><Catalog initialPage={initialPage} facets={facets}/></section>;
}
